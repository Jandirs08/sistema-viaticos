            ...
            <table class="erp-table" aria-label="Bandeja de rendiciones">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Solicitud</th>
                        <th scope="col" aria-sort="none" data-sort-key="fecha" data-sort-type="date" class="sortable"><span class="th-inner">Fecha viaje<span class="sort-arrows"><svg class="arrow-asc" width="8" height="5" viewBox="0 0 8 5" fill="currentColor"><path d="M0 5L4 0L8 5Z"/></svg><svg class="arrow-desc" width="8" height="5" viewBox="0 0 8 5" fill="currentColor"><path d="M0 0L4 5L8 0Z"/></svg></span></span></th>
                        <th scope="col" aria-sort="none" data-sort-key="monto" data-sort-type="num" class="sortable num"><span class="th-inner">Anticipo<span class="sort-arrows"><svg class="arrow-asc" width="8" height="5" viewBox="0 0 8 5" fill="currentColor"><path d="M0 5L4 0L8 5Z"/></svg><svg class="arrow-desc" width="8" height="5" viewBox="0 0 8 5" fill="currentColor"><path d="M0 0L4 5L8 0Z"/></svg></span></span></th>
                        <th scope="col" aria-sort="none" data-sort-key="saldo" data-sort-type="num" class="sortable num"><span class="th-inner">Saldo<span class="sort-arrows"><svg class="arrow-asc" width="8" height="5" viewBox="0 0 8 5" fill="currentColor"><path d="M0 5L4 0L8 5Z"/></svg><svg class="arrow-desc" width="8" height="5" viewBox="0 0 8 5" fill="currentColor"><path d="M0 0L4 5L8 0Z"/></svg></span></span></th>
                        <th scope="col" aria-sort="none" data-sort-key="gastos_count" data-sort-type="num" class="sortable num"><span class="th-inner">Gastos<span class="sort-arrows"><svg class="arrow-asc" width="8" height="5" viewBox="0 0 8 5" fill="currentColor"><path d="M0 5L4 0L8 5Z"/></svg><svg class="arrow-desc" width="8" height="5" viewBox="0 0 8 5" fill="currentColor"><path d="M0 0L4 5L8 0Z"/></svg></span></span></th>
                        <th scope="col">Estado</th>
                        <th scope="col">Acción</th>
                    </tr>
                </thead>
