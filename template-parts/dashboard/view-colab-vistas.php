            ...
            <table class="erp-table" aria-label="Mis solicitudes de viáticos">
                <thead>
                    <tr>
                        ...
                        <th scope="col" aria-sort="none" data-sort-key="monto" data-sort-type="num" class="sortable"><span class="th-inner">Monto Solicitado<span class="sort-arrows"><svg class="arrow-asc" width="8" height="5" viewBox="0 0 8 5" fill="currentColor"><path d="M0 5L4 0L8 5Z"/></svg><svg class="arrow-desc" width="8" height="5" viewBox="0 0 8 5" fill="currentColor"><path d="M0 0L4 5L8 0Z"/></svg></span></span></th>
