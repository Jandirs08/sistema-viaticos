                ...
                <section class="wizard-panel is-active" data-step="1" aria-labelledby="wz-step1-title">
                    ...
                    <div class="form-group">
                        ...
                        <div class="dropzone" id="rg-dropzone">
                            <input type="file" id="rg-adj-input" accept=".pdf,.jpg,.jpeg,.png,.webp,.heic,.heif" multiple hidden>
                            <button type="button" class="dropzone-empty" id="dz-empty">
                                ...
                                <span class="dropzone-sub">o haz clic para buscar · PDF, JPG, PNG, WEBP, HEIC</span>
                            </button>
